...
ActiveRecord::Base.send(:include, Authorize::AuthorizationsTable, Authorize::AuthorizationsTable::TrusteeExtensions, Authorize::AuthorizationsTable::SubjectExtensions)
